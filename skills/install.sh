...
- `/pd:build-ada-agent Air Canada` (no website — will skip live scrape)
- `/pd:build-ada-agent Contabo GmbH https://contabo.com` → SC adds a 3rd action → script runs with `--actions 3`
